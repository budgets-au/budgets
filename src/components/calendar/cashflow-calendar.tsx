...
export function CashflowCalendar({
  ...
  const scheduledById = useMemo(() => {
    const m = new Map<
      string,
      { frequency: string; interval: number; payee: string | null }
    >();
    ...
    <div className="h-full flex flex-col gap-3">
      ...
      <div className="shrink-0 flex items-center justify-between gap-3">
        ...
        <div
          ...
          style={{
            display: "grid",
            // Cap the calendar at 350px. Cells land around 47px —
            // comfortable room for the date number above the
            // 4 px-dot row. Chart fills whatever's left.
            gridTemplateColumns: isLgUp ? "minmax(0, 350px) 1fr" : "1fr",
        ...
        >
          ...
          <Card className="flex flex-col overflow-hidden py-0 gap-0">
            ...
            <CardContent className="px-2 sm:px-3 pt-0 pb-1 flex flex-col">
              ...
              >
                ...
                {monthDays.map((day) => {
                  ...
                  const unmatchedScheduled = (data?.scheduledEvents ?? [])
